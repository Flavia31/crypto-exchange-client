...
const Register = () => {
  ...
  const registerSchema = Yup.object({
    username: Yup.string().min(4, 'Too short').max(50, 'Too long').required(),
    email: Yup.string().email().required(),
    displayName: Yup.string().min(3, 'Too short').max(50, 'Too long').required(),
  ...
  return (
    <div className="mainWrapper">
      <Paper className="columnsWrapper" elevation={8}>
        <div className="flexLeft">
          ...
          <form autoComplete="off" onSubmit={formik.handleSubmit}>
            ...
            <TextField
              ...
              onChange={formik.handleChange}
              error={formik.values.displayName && formik.errors.displayName}
              helperText={formik.values.displayName && formik.errors.displayName}
            />
            <TextField
              fullWidth
              name="password"
        ...
        <img className="flexRight" src={registerPhoto} alt="Register Logo" />
      </Paper>
    </div>
  )
}
